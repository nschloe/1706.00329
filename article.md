...
### 2.1 The confluent hypergeometric $`\Phi`$
...
### 3.1 Zero-dimensional $`\phi^{4}`$ field theroy
...
### 3.2 The Euler-Heisenberg effective Lagrangian
...
### 3.3 One-dimensional $`\phi^{4}`$ field theory: the quartic anharmonic oscillator
...
### 3.4 Implementation of the large-order behavior of the perturbation coefficients
...
## 4 $`\Phi`$-Padé approximants for Gevrey-summable series
...
### 4.1 The sextic anharmonic oscillator
...
in [Fig. 2](#figure-2) it is difficult to distinguish between the exact and
